...
const docAccess_1 = require("payload/dist/globals/operations/docAccess");
...
async function handler(req, res) {
    ...
    try {
        const globalAccessResult = await (0, docAccess_1.docAccess)({
            req,
            globalConfig,
        });
        return res.status(http_status_1.default.OK).json(globalAccessResult);
    }
    catch (error) {
