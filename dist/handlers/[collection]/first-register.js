...
const registerFirstUser_1 = __importDefault(require("payload/dist/auth/operations/registerFirstUser"));
...
async function handler(req, res) {
    ...
    try {
        ...
        return res.status(http_status_1.default.OK).json(firstUser);
    }
    catch (error) {
...
exports.default = (0, withPayload_1.default)((0, dataLoader_1.default)((0, fileUpload_1.default)((0, cookie_1.default)((0, convertPayloadJSONBody_1.default)(handler)))));
//# sourceMappingURL=first-register.js.map